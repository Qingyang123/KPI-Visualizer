...
var slideIndex = 0;
title1 = 'Youtube Subscribers <span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span> ' +
         'Views <span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span> ' +
         'Videos Published';
title2 = 'Youtube Monthly Comments <span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span> ' +
         'Monthly Number of Likes';
title3 = 'Youtube Desktop, Mobile, Tablet, TV <span class="ampersand">&</span> Other Views';
title4 = 'Monthly MP4 <span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span>  ' +
         'PDF Downloads';
title5 = 'Pistacja Sessions <span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span> ' +
         'Users';
title6 = 'Pistacja Data from Jira';

title7 = 'CNX Data from Jira';

titlesNumber = [title1, title2, title3, title4, title5, title6, title7];
...
setInterval(reloadTest, 86400000);
